      ...
      <section className="container pt-4">
        <div className="row align-items-center">
          <div className="col-auto pr-5" style={{ width: 530 }}>
            ...
            >
              Kami menyediakan apa yang Anda butuhkan untuk menikmati liburan Anda bersama keluarga. Waktu
              untuk membuat momen tak terlupakan lainnya.
            </p>
            <Button
              className="btn px-5"
              hasShadow
